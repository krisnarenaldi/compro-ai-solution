...
export default function Footer() {
  return (
    <footer className="w-full py-16 bg-[#353839] max-w-container-max mx-auto px-margin-desktop">
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-8">
        <div className="space-y-4">
          <p className="font-display-lg text-headline-lg text-primary">Aetheris AI</p>
